import Foundation
import SafariMCPCore

// Launcher only. Everything testable lives in SafariMCPCore, which the test target
...
do {
    ...
    FileHandle.standardError.write(
        Data("apple-safari-mcp: \(error.localizedDescription)\n".utf8))
    exit(1)
}
